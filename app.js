...
const SUPABASE_ANON_KEY = 'PASTE_KEY_LENGKAP_DI_SINI';
...
async function loadMateri(isGuru) {
  ...
  if (error) { console.error(error); showToast('Gagal memuat materi', 'error'); return; }
...
// ------------------------------------------------------------
const SUPABASE_URL = 'https://ddnhwcxfktcsyngupdex.supabase.co';
const SUPABASE_ANON_KEY = 'PASTE_DI_SINI_KEY_LENGKAP';
